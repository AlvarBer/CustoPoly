package com.iplusplus.custopoly.main.Activities;

import android.os.Bundle;
import android.support.v7.app.ActionBarActivity;
import android.view.Menu;
import android.view.MenuItem;
import com.iplusplus.custopoly.main.R;
 ...
 *
 * Access to the model is done via ModelFacade.getInstance().[methodname]
 *  EXAMPLE:
...
public class PreGameActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //setContentView(R.layout.menu_pre_game_activity);
    }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        //getMenuInflater().inflate(R.menu.menu_pre_game_activity, menu);
        return true;
    }
